...
@section("content")
    <section class="mt-16">
        ...
        @if(session('success'))
            <div id="toast-success" class="right-3 ml-auto flex items-center w-full max-w-xs p-4 mb-2 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
        ...
        @elseif(session('error'))
            <div id="toast-danger" class="right-3 ml-auto flex items-center w-full max-w-xs p-4 mb-2 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
